	...
	public static void main(String[] args) {
		...
		//Creamos el objeto Scanner para leer inputs del usuario
			 Scanner sc = new Scanner(System.in);
		        ...
		        valor1 = 0;
		        valor2 = 0;
	/*Crearemos dos condicionales do-while donde mientras el usuario no introduzca uno de las 6 posibilidades del dado se le seguira preguntando hasta que este lo introduzca*/	        
do {
	...
	}while(!(tirada1.equalsIgnoreCase("UNO") || (tirada1.equalsIgnoreCase("DOS")) || (tirada1.equalsIgnoreCase("TRES")) || (tirada1.equalsIgnoreCase("CUATRO") || (tirada1.equalsIgnoreCase("CINCO") || (tirada1.equalsIgnoreCase("SEIS"))))));
do {
   ...
   tirada2 = sc.next().toUpperCase(); // Convertir la entrada a mayúsculas
		    /*Hacemos el mismo proceso en este condicional switch solo que esta vez solo transformara el valor de la primera tirada introducida por el usuario*/
		        ...
		        }while(!(tirada2.equalsIgnoreCase("UNO") || (tirada2.equalsIgnoreCase("DOS")) || (tirada2.equalsIgnoreCase("TRES")) || (tirada2.equalsIgnoreCase("CUATRO") || (tirada2.equalsIgnoreCase("CINCO") || (tirada2.equalsIgnoreCase("SEIS"))))));
